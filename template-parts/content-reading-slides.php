<?php
/**
 * The template for displaying the Reading slide posts.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> data-transition="fade" <?php opening_times_post_attributes(); ?>>
    <div id="<?php opening_times_the_slug(); ?>" class="container-fluid sceneElement">
        <div class="card-block row">
            ...
            <div class="entry-content mx-auto col-md-12 mb-5">
