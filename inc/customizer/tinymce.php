...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class opening_times_footer_text_Text_Editor_Custom_Control extends WP_Customize_Control {
		...
		protected function enqueue_scripts() {
			...
			wp_enqueue_script( 'opening_times-customize-editor-js', get_template_directory_uri() . '/js/tinymce.js', array( 'jquery' ), '1.0.0', true );
		}
